...
export class DummyChatService implements ChatService {
      ...
      conversations: [
        {
          ...
          unreadCount: 0,
          summary: 'Discussion about optimizing SQL query performance with JOIN operations and WHERE clauses.',
        },
        {
          id: '2',
          ...
          unreadCount: 1,
          summary: 'Question about React component re-rendering performance issues.',
        },
        {
          id: '3',
          ...
          unreadCount: 0,
          summary: 'Help with setting up database connection pooling for Node.js application.',
        },
      ],
      messages: {
        '1': [
  ...
  async getMessages(conversationId: string): Promise<Message[]> {
    ...
    // Ensure all messages have isAutoGenerated field (default to false if missing)
    const normalizedMessages = messages.map(msg => ({
      ...msg,
      isAutoGenerated: msg.isAutoGenerated ?? false,
    }));
    return this.delayResponse(normalizedMessages);
  }
